...
使用方法:
  uv run python scripts/benchmark_pytorch_vs_jax.py   # ルートのシム（実体は benchmarks/）
  uv run python scripts/benchmarks/benchmark_pytorch_vs_jax.py --device cuda
  uv run python scripts/benchmarks/benchmark_pytorch_vs_jax.py --warmup 20 --iters 100
  uv run python scripts/benchmarks/benchmark_pytorch_vs_jax.py --profile
"""
import argparse
import cProfile
import os
